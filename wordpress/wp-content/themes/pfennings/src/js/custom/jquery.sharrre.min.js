...
(function(t, n, r, i) {
    function h(e, n) {
        this.element = e;
        this.options = t.extend(true, {}, u, n);
    ...
    var o = "sharrre",
        ...
        f = {
            googlePlus: function(e) {
                ...
                t(e.element).find(".buttons").append('<div class="button googleplus"><div class="g-plusone" data-size="' + i.size + '" data-href="' + (i.url !== "" ? i.url : e.options.url) + '" data-annotation="' + i.annotation + '"></div></div>');
                n.___gcfg = {
                    lang: e.options.buttons.googlePlus.lang
                };
                var s = 0;
                if (typeof gapi === "undefined" && s == 0) {
                    s = 1;
                    (function() {
                        ...
                        var t = r.getElementsByTagName("script")[0];
            ...
            facebook: function(e) {
                ...
                if (typeof FB === "undefined" && i == 0) {
                    ...
                    (function(e, t, r) {
                        ...
                        i = e.createElement(t);
                        i.id = r;
                        i.src = "//connect.facebook.net/" + n.lang + "/all.js#xfbml=1";
                        s.parentNode.insertBefore(i, s)
                    })(r, "script", "facebook-jssdk")
                } else {
                    FB.XFBML.parse()
                }
            },
            ...
            digg: function(e) {
                ...
                t(e.element).find(".buttons").append('<div class="button digg"><a class="DiggThisButton ' + n.type + '" rel="nofollow external" href="//digg.com/submit?url=' + encodeURIComponent(n.url !== "" ? n.url : e.options.url) + '"></a></div>');
                var i = 0;
                if (typeof __DBW === "undefined" && i == 0) {
                    i = 1;
                    (function() {
                        var e = r.createElement("SCRIPT"),
                        ...
                        e.type = "text/javascript";
                        e.async = true;
                        e.src = "//widgets.digg.com/buttons.js";
                        t.parentNode.insertBefore(e, t)
                    })()
                }
            },
            delicious: function(e) {
                if (e.options.buttons.delicious.size == "tall") {
                    var n = "width:50px;",
                        r = "height:35px;width:50px;font-size:15px;line-height:35px;",
                        i = "height:18px;line-height:18px;margin-top:3px;"
                } else {
                    var n = "width:93px;",
                        r = "float:right;padding:0 3px;height:20px;width:26px;line-height:20px;",
            ...
            pinterest: function(e) {
                ...
                t(e.element).find(".buttons").append('<div class="button pinterest"><a href="//pinterest.com/pin/create/button/?url=' + (n.url !== "" ? n.url : e.options.url) + "&media=" + n.media + "&description=" + n.description + '" class="pin-it-button" count-layout="' + n.layout + '">Pin It</a></div>');
                (function() {
                    var e = r.createElement("script");
                    e.type = "text/javascript";
                    e.async = true;
        ...
        c = {
            ...
            facebook: function(e) {
                n.open("//www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(e.buttons.facebook.url !== "" ? e.buttons.facebook.url : e.url) + "&t=" + e.text + "", "", "toolbar=0, status=0, width=900, height=500")
            },
            twitter: function(e) {
            ...
            digg: function(e) {
                n.open("//digg.com/tools/diggthis/submit?url=" + encodeURIComponent(e.buttons.digg.url !== "" ? e.buttons.digg.url : e.url) + "&title=" + e.text + "&related=true&style=true", "", "toolbar=0, status=0, width=650, height=360")
            },
            delicious: function(e) {
                n.open("//www.delicious.com/save?v=5&noui&jump=close&url=" + encodeURIComponent(e.buttons.delicious.url !== "" ? e.buttons.delicious.url : e.url) + "&title=" + e.text, "delicious", "toolbar=no,width=550,height=550")
            },
            stumbleupon: function(e) {
                n.open("//www.stumbleupon.com/badge/?url=" + encodeURIComponent(e.buttons.delicious.url !== "" ? e.buttons.delicious.url : e.url), "stumbleupon", "toolbar=no,width=550,height=550")
            },
            linkedin: function(e) {
            ...
            pinterest: function(e) {
                n.open("//pinterest.com/pin/create/button/?url=" + encodeURIComponent(e.buttons.pinterest.url !== "" ? e.buttons.pinterest.url : e.url) + "&media=" + encodeURIComponent(e.buttons.pinterest.media) + "&description=" + e.buttons.pinterest.description, "pinterest", "toolbar=no,width=700,height=300")
            }
        };
    h.prototype.init = function() {
        var e = this;
        if (this.options.urlCurl !== "") {
            a.googlePlus = this.options.urlCurl + "?url={url}&type=googlePlus";
            a.stumbleupon = this.options.urlCurl + "?url={url}&type=stumbleupon"
        }
        t(this.element).addClass(this.options.className);
        if (typeof t(this.element).data("title") !== "undefined") {
            this.options.title = t(this.element).attr("data-title")
        }
        if (typeof t(this.element).data("url") !== "undefined") {
            this.options.url = t(this.element).data("url")
        }
        if (typeof t(this.element).data("urlalt") !== "undefined") {
            this.options.urlalt = t(this.element).data("urlalt")
        }
        if (typeof t(this.element).data("text") !== "undefined") {
            this.options.text = t(this.element).data("text")
        }
        t.each(this.options.share, function(t, n) {
            if (n === true) {
                e.options.shareTotal++
            }
        });
        if (e.options.enableCounter === true) {
            t.each(this.options.share, function(t, n) {
                if (n === true) {
                    try {
                        e.getSocialJson(t);
                        e.getSocialJson(getSocialAltJson)
                    } catch (r) {}
                }
            })
        } else if (e.options.template !== "") {
            this.options.render(this, this.options)
        } else {
            this.loadButtons()
        }
        t(this.element).hover(function() {
            if (t(this).find(".buttons").length === 0 && e.options.enableHover === true) {
                e.loadButtons()
            }
    ...
    h.prototype.loadButtons = function() {
        ...
        t.each(e.options.share, function(t, n) {
            if (n == true) {
                f[t](e);
                if (e.options.enableTracking === true) {
                    l[t]()
                }
            }
        })
    ...
    h.prototype.getSocialJson = function(e) {
        var n = this,
            r = 0,
            i = a[e].replace("{url}", encodeURIComponent(this.options.url));
        n.options.hideCount = 0;
        if (this.options.buttons[e].urlCount === true && this.options.buttons[e].url !== "") {
            i = a[e].replace("{url}", this.options.buttons[e].url)
        }
        if (i != "" && n.options.urlCurl !== "") {
            t.getJSON(i, function(t) {
                if (null != t) {
                    if (typeof t.count !== "undefined") {
                        ...
                        i = i.replace("Â ", "");
                        r += parseInt(i, 10)
                    } else if (t.data && t.data.length > 0 && typeof t.data[0].total_count !== "undefined") {
                        r += parseInt(t.data[0].total_count, 10)
                    } else if (typeof t[0] !== "undefined") {
                        r += parseInt(t[0].total_posts, 10)
                    } else if (typeof t[0] !== "undefined") {}
                    n.options.count[e] = r;
                    n.options.total += r;
                    n.renderer();
    ...
    h.prototype.getSocialAltJson = function(e) {
        var n = this,
            r = 0,
            i = a[e].replace("{url}", encodeURIComponent(this.options.urlalt));
        n.options.hideCount = 0;
        if (this.options.buttons[e].urlCount === true && this.options.buttons[e].url !== "") {
            i = a[e].replace("{url}", this.options.buttons[e].url)
        }
    ...
    h.prototype.renderer = function() {
        ...
        if (hideCount) {
            t(this.element).html('<div class="box no-count">' + (this.options.title !== "" ? '<a class="share" href="#">' + this.options.title + "</a>" : "") + "</div>")
        } else {
            if (this.options.shorterTotal === true) {
                e = this.shorterTotal(e)
            }
            if (n !== "") {
                n = n.replace("{total}", e);
        ...
        if (e === i || typeof e === "object") {
            return this.each(function() {
                if (!t.data(this, "plugin_" + o)) {
                    t.data(this, "plugin_" + o, new h(this, e))
                }
            })
        } else if (typeof e === "string" && e[0] !== "_" && e !== "init") {
            return this.each(function() {
                var r = t.data(this, "plugin_" + o);
                if (r instanceof h && typeof r[e] === "function") {
                    r[e].apply(r, Array.prototype.slice.call(n, 1))
                }
            })
        }
    }
